      ...
      <main ref={pageRef as React.RefObject<HTMLElement>} style={{ background: '#000', minHeight: '100vh' }}>
        ...
        <section style={{ padding: '140px 0 64px', position: 'relative', overflow: 'hidden' }}>
          <div style={{
            ...
            background: 'radial-gradient(circle, rgba(180,253,131,0.05) 0%, transparent 65%)',
            pointerEvents: 'none',
          }} />
          <div className="cb-container">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
              <span className="reveal reveal-d1" style={{
                ...
                background: 'rgba(180,253,131,0.12)', color: '#b4fd83',
                padding: '5px 14px', borderRadius: 100,
              }}>Business</span>
              <span className="reveal reveal-d1" style={{ fontSize: 13, color: 'rgba(255,255,255,0.3)' }}>March 13, 2026</span>
            ...
            <div className="reveal reveal-d4" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                <div style={{
                  ...
                  background: 'rgba(180,253,131,0.12)', border: '1px solid rgba(180,253,131,0.25)',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <button onClick={handleCopy} style={{
                  ...
                  background: copied ? 'rgba(180,253,131,0.1)' : 'rgba(255,255,255,0.04)',
                  color: copied ? '#b4fd83' : 'rgba(255,255,255,0.55)',
              ...
              <article>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="greencart">
                  <div style={{
                    ...
                    <div style={{
                      padding: '14px 20px', borderRadius: 12,
                      background: 'rgba(180,253,131,0.06)', border: '1px solid rgba(180,253,131,0.12)',
                      display: 'flex', alignItems: 'center', gap: 10,
                    }}>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#b4fd83" strokeWidth="2">
                        <polyline points="22,7 13.5,15.5 8.5,10.5 2,17"/><polyline points="16,7 22,7 22,13"/>
                      </svg>
                      <span style={{ fontSize: 13, color: '#b4fd83', fontWeight: 600 }}>
                ...
                <div className="reveal" style={{ marginBottom: 64 }}>
                  <div style={{
                    background: 'rgba(180,253,131,0.04)', border: '1px solid rgba(180,253,131,0.15)',
                    borderRadius: 24, padding: 36,
                  }}>
                    <h3 style={{
                      fontSize: 18, fontWeight: 700, color: '#b4fd83',
                      ...
                      {[
                        ...
                        <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
                          <span style={{
                            ...
                            background: 'rgba(180,253,131,0.15)', color: '#b4fd83',
                    ...
                    <nav style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                      {apps.map(app => (
                        <a key={app.name} href={`#${app.name.toLowerCase()}`} style={{
                          ...
                          onMouseEnter={e => {
                            (e.currentTarget as HTMLAnchorElement).style.color = '#b4fd83';
                            (e.currentTarget as HTMLAnchorElement).style.background = 'rgba(180,253,131,0.06)';
                          }}
                          onMouseLeave={e => {
                        ...
                        >
                          ...
                          <span>{app.name}</span>
                          <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.25)', marginLeft: 'auto' }}>{app.category}</span>
                        </a>
                      ))}
                    </nav>
                  </div>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
                      <div style={{
                        ...
                        background: 'rgba(180,253,131,0.12)', border: '1px solid rgba(180,253,131,0.25)',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontSize: 14, fontWeight: 700, color: '#b4fd83', flexShrink: 0,
                      }}>RM</div>
                      <div>
                    ...
                    <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, margin: 0 }}>
                      Former Google engineer and founder of Mapletech Labs. Has led engineering for 300+ product launches globally.
                    </p>
                  </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                      {relatedPosts.map(post => (
                        <Link key={post.slug} href={`/blog/${post.slug}`} style={{
                          ...
                          onMouseEnter={e => {
                            (e.currentTarget as HTMLAnchorElement).style.borderColor = 'rgba(180,253,131,0.15)';
                            (e.currentTarget as HTMLAnchorElement).style.background = 'rgba(180,253,131,0.03)';
                          }}
                          onMouseLeave={e => {
                        ...
                        >
                          <p style={{ fontSize: 11, color: '#b4fd83', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', margin: '0 0 6px' }}>{post.category}</p>
          ...
          <div className="cb-container" style={{ paddingTop: 80 }}>
            ...
            >
              ...
              <Link href="/contact" style={{ textDecoration: 'none' }}>
                <button style={{
                  padding: '18px 40px', borderRadius: 100, background: '#b4fd83', color: '#000',
