  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{
          height: '100%', background: '#b4fd83',
          width: `${progress}%`,
          transition: 'width 0.1s linear',
          boxShadow: '0 0 8px rgba(180,253,131,0.6)',
        }} />
      </div>
      ...
      <div style={{
        ...
        <Link href="#contact" style={{
          ...
          background: '#b4fd83', color: '#000', fontSize: 14, fontWeight: 700,
          textDecoration: 'none',
          boxShadow: '0 8px 32px rgba(180,253,131,0.4), 0 2px 8px rgba(0,0,0,0.4)',
          transition: 'transform 0.2s ease, box-shadow 0.2s ease',
        }}
          onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 16px 40px rgba(180,253,131,0.5), 0 4px 12px rgba(0,0,0,0.4)'; }}
          onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = '0 8px 32px rgba(180,253,131,0.4), 0 2px 8px rgba(0,0,0,0.4)'; }}
        >
      ...
      <button
        ...
        onMouseEnter={e => { e.currentTarget.style.background = 'rgba(180,253,131,0.2)'; e.currentTarget.style.borderColor = 'rgba(180,253,131,0.4)'; }}
