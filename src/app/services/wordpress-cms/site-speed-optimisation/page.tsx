        ...
        <section ref={heroRef} style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', paddingTop: 140, paddingBottom: 80, background: 'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(180,253,131,0.12) 0%, transparent 70%)' }}>
          <div className="cb-container">
            <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 28, fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>
              ...
              <span>/</span>
              <span style={{ color: '#b4fd83' }}>Site Speed Optimisation</span>
            </div>
            <div className="reveal reveal-d1" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 16px', borderRadius: 100, background: 'rgba(180,253,131,0.08)', border: '1px solid rgba(180,253,131,0.2)', marginBottom: 24 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 600, color: '#b4fd83', letterSpacing: '0.05em' }}>WORDPRESS & CMS</span>
            </div>
            <h1 className="reveal reveal-d2" style={{ fontSize: 'clamp(36px, 6vw, 72px)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 24, maxWidth: 800 }}>
              WordPress Site Speed <span style={{ color: '#b4fd83' }}>Optimisation</span>
            </h1>
            <p className="reveal reveal-d3" style={{ fontSize: 18, color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, maxWidth: 600, marginBottom: 40 }}>Transform a slow, frustrating WordPress site into a 90+ Lighthouse score performer — passing Core Web Vitals, ranking higher, and converting more.</p>
